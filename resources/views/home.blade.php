...
<body>  
    ...
    <div class="main relative">  
        <div class="container mx-auto text-justify items-center grid grid-cols-2 gap-4">  
            ...
            <!-- hero image -->
            <img class="w-full" src="{{ URL::asset('img/hero.svg'); }}">
        </div>  
        <div class="flex flex-col justify-center text-center text-white text-sm mt-10">
            Show more
            <div class="flex justify-center">
                <img class="mt-3 hero-arrow" src="{{ URL::asset('img/arrow.svg'); }}">
            </div>
        </div>
    ...
    <div class="profil text-center relative flex justify-center flex-col">
        <h2 class="underline mb-10">Berita Terkini</h2>
        <div class="flex flex-row justify-center gap-4">
            <div class="news container w-1/5 rounded-lg">
                <img class="rounded-lg w-full h-full object-cover" src="{{ URL::asset('img/news-static.svg'); }}" alt="">
            </div>
            <div class="news container w-1/5 rounded-lg">
                <img class="rounded-lg w-full h-full object-cover" src="{{ URL::asset('img/news-static.svg'); }}" alt="">
            </div>
        ...
        <h2 class="underline my-10 mt-20">Peta Serangan Siber</h2>
        ...
        <div class="absolute bottom-0 left-0 right-0">
            <img style="width: 100%;" src="{{ URL::asset('img/wave-dark.svg'); }}">
        </div>
    </div>
    <!-- contact us -->
    <div class="visimisi">
        <div class="container mx-auto text-justify items-center grid grid-cols-2 gap-10">  
            ...
            <div class="container flex justify-start flex-col">
                <h2 class="underline mb-3">Hubungi Kami</h2>
                <table>
                    <tr>
                        <td class="w-7 py-2"><img class="w-4" src="{{ URL::asset('img/location.svg'); }}" alt=""></td>
                        <td class="text-sm">Jl. MT Haryono Kav No. 10 Cawang Jakarta Timur 13340</td>
                    </tr>
                    <tr>
                        <td class="w-7 py-2"><img class="w-4" src="{{ URL::asset('img/phone.svg'); }}" alt=""></td>
                        <td class="text-sm">(021)8508510</td>
                    </tr>
                    <tr>
                        <td class="w-7 py-2"><img class="w-4" src="{{ URL::asset('img/email.svg'); }}" alt=""></td>
                        <td class="text-sm">csirt@waskita.co.id</td>
                    </tr>
                    <tr>
                        <td class="w-7 py-2"><img class="w-4" src="{{ URL::asset('img/time.svg'); }}" alt=""></td>
