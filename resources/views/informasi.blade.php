...
<body>  
    ...
    <div class="profil text-center relative">
        <h2 class="underline mb-10">Acara</h2>
    ...
    <div class="visimisi">
        ...
        <div class="text-center pb-10">
            <h2 class="underline">Galeri Kegiatan</h2>
        </div>
        <!-- baris 1 -->
    ...
    <div class="absolute top-0 left-0 right-0">
        ...
        <!-- title -->
        <h2 class="berita underline mb-10 mt-10">Berita Terkini</h2>
            ...
            <div class="container p-4 my-4 flex justify-start text-justify flex flex-col">
                ...
                <div class="flex flex-row my-3">
                    <div class="me-3 flex flex-row">
                        <img class="w-5 me-2" src="{{ URL::asset('img/calendar.svg'); }}" alt="">
                        <p class="text-sm text-gray-400">yyyy-mm-dd</p>
                    </div>
                    <div class="ms-3 flex flex-row">
                        <img class="w-5 me-2" src="{{ URL::asset('img/user.svg'); }}" alt="">
                ...
                <a href="{{ url('/news') }}"><button class="news-detail mt-4 py-1 flex flex-row justify-center items-center">
                    <img class="w-5 me-4" src="{{ URL::asset('img/arrow-down.svg'); }}" alt="">
                    Selengkapnya...
                </button></a>
            </div>
            <!-- berita 2 -->
